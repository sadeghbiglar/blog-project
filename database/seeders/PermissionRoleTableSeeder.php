...
class PermissionRoleTableSeeder extends Seeder
{
    public function run()
    {
        DB::table('permission_role')->insert([
            ...
            ['permission_id' => 4, 'role_id' => 5, 'created_at' => now(), 'updated_at' => now()],
            ['permission_id' => 1, 'role_id' => 2, 'created_at' => now(), 'updated_at' => now()],
            ['permission_id' => 2, 'role_id' => 2, 'created_at' => now(), 'updated_at' => now()],
            ['permission_id' => 1, 'role_id' => 6, 'created_at' => now(), 'updated_at' => now()],
            ['permission_id' => 4, 'role_id' => 6, 'created_at' => now(), 'updated_at' => now()],
            ['permission_id' => 10, 'role_id' => 6, 'created_at' => now(), 'updated_at' => now()],
